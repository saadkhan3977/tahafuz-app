...
// Route::get('auth/member/quote_update/{id}',[App\Http\Controllers\Api\Member\QuoteController::class,'update']);
...
Route::group(['middleware' => ['api','auth:api'], 'prefix' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'member'], function ()
    {
	    ...
	    Route::post('quote_image_remove/{quoteid}',[App\Http\Controllers\Api\Member\QuoteController::class,'quote_image_remove']);
